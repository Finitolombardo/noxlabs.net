        ...
        <div className="mb-24">
          ...
          >
            <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-6 mb-3">
              ...
              <Link
                to="/solution-finder"
                className="inline-flex items-center justify-center gap-2 px-6 py-3 bg-gradient-to-r from-nox-red to-nox-red-hover text-black rounded-lg hover:shadow-lg hover:shadow-nox-red/20 transition-all font-semibold whitespace-nowrap"
              >
          ...
          >
            {mainSystems.map((system) => (
              <motion.div key={system.slug} variants={itemVariants}>
                <div className="bg-gradient-to-br from-gray-900/50 to-gray-800/30 border border-white/10 rounded-2xl p-8 hover:border-nox-red/30 transition-all h-full flex flex-col">
                  <h3 className="text-2xl font-bold text-nox-white mb-4">{system.name}</h3>
                  <p className="text-nox-white-muted mb-6 leading-relaxed">
                    {system.description}
                  </p>
                  ...
                  <div className="mb-6 flex-grow">
                    <ul className="space-y-2">
                      {system.properties.map((property, idx) => (
                        <li key={idx} className="text-nox-white-muted text-sm">
                          • {property}
                        </li>
                      ))}
                    </ul>
                  ...
                  <div className="mt-auto">
                    <Link
                      ...
                      className="flex items-center justify-center gap-2 px-4 py-2.5 bg-white/5 hover:bg-white/10 text-nox-white rounded-lg border border-white/10 hover:border-nox-red/30 transition-all text-sm font-medium"
                    >
                      Details ansehen
                ...
                <div className="bg-gradient-to-br from-gray-900/50 to-gray-800/30 border border-white/10 rounded-2xl p-8 hover:border-white/20 transition-all h-full flex flex-col">
                  ...
                  <div className="flex flex-col gap-3 mt-auto">
                    ...
                    {system.isConfigurable && (
                      <Link
                        to="/solution-finder"
                        className="flex items-center justify-center gap-2 px-4 py-2.5 bg-gradient-to-r from-nox-red to-nox-red-hover text-black rounded-lg hover:shadow-lg hover:shadow-nox-red/20 transition-all text-sm font-semibold"
                      >
                        Setup anfragen
                      </Link>
                    )}
