                ...
                {mutationVariables.map((variable, index) => (
                  ...
                  >
                    <div className="flex items-center gap-3 mb-3">
                      ...
                      <h4 className="text-white font-semibold">{variable.name}</h4>
                    </div>
                    <p className="text-sm text-gray-400 leading-relaxed">{variable.effect}</p>
                  </div>
                ))}
              </div>

              <h3 className="text-xl font-semibold text-white mb-6">Lernregeln</h3>
              <div className="space-y-4 mb-8">
                {learningRules.map((item, index) => (
                  ...
                  >
                    ...
                    <p className="text-sm text-gray-400 ml-9">{item.why}</p>
                  </div>
                ))}
              </div>
              ...
              <div className="mt-8 bg-gradient-to-br from-gray-900/50 to-gray-800/30 border border-white/10 rounded-xl p-6">
                ...
                <div className="space-y-3">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <strong className="text-white">Getrennte Versandpfade:</strong>
                  ...
                  <div className="flex items-start gap-3">
                    <CheckCircle2 className="w-5 h-5 text-[#d6a400] flex-shrink-0 mt-0.5" />
                    <div>
                      <strong className="text-white">Keine Signalvermischung:</strong>
                      <span className="text-sm text-gray-400 block mt-1">
                  ...
                  <div className="flex items-start gap-3">
                    <CheckCircle2 className="w-5 h-5 text-[#d6a400] flex-shrink-0 mt-0.5" />
                    <div>
                      <strong className="text-white">Höhere Lerngeschwindigkeit:</strong>
                      <span className="text-sm text-gray-400 block mt-1">
              ...
              <div className="bg-gradient-to-br from-gray-900/50 to-gray-800/30 border border-white/10 rounded-xl p-6">
                <div className="space-y-4 text-gray-300">
                  <div className="flex items-start gap-3">
                    <span className="text-[#d6a400] mt-1">•</span>
                    <div>
                      <strong className="text-white">Monatlicher Retainer:</strong>
                      <span className="text-sm text-gray-400 block mt-1">
                  ...
                  <div className="flex items-start gap-3">
                    <span className="text-[#d6a400] mt-1">•</span>
                    <div>
                      <strong className="text-white">Aktive Weiterentwicklung:</strong>
                      <span className="text-sm text-gray-400 block mt-1">
